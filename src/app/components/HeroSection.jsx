            ...
            <div className='col-span-7 place-self-center text-center sm:text-left'>
                ...
                <div className='relative'>
                    ...
                    <button className='px-1 py-1 sm:w-fit w-full rounded-full bg-gradient-to-br from-red-500 via-purple-500 to-pink-500  hover:bg-slate-800'>
                        <span className='block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2'><Link href={"https://drive.google.com/file/d/1RJlBzSivoTSkywb7FIg8odsiuYGX0wct/view?usp=sharing"}>Download CV!</Link></span>
                    </button>
                </div>
